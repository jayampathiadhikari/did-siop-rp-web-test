...
export declare class DidSiopRequest {
     ...
     */
    static validateRequest(request: string): Promise<JWT.JWTObject | any>;
    /**
     ...
     */
    static generateRequest(rp: RPInfo, signingInfo: JWT.SigningInfo, queryParams: any, options: any): Promise<string>;
}
