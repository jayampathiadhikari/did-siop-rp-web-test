...
var Provider = /** @class */ (function () {
     ...
     */
    Provider.prototype.generateResponse = function (decodedRequest, request, expiresIn) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Response_1.DidSiopResponse.generateResponse(decodedRequest, signing_info, this.identity, expiresIn, this.crypto, request, this.storage)];
