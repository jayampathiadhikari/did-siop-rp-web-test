...
var DidSiopRequest = /** @class */ (function () {
    ...
    DidSiopRequest.generateRequest = function (rp, signingInfo, queryParams, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                url = 'openid://';
                query = __assign({ response_type: (options.response_type === 'code' || options.response_type === 'id_token') ? options.response_type : 'id_token', client_id: rp.redirect_uri, scope: 'openid did_authn' }, queryParams);
                if (rp.request_uri) {
                    ...
                    jwtPayload = __assign(__assign({ iss: rp.did, scope: 'openid did_authn', client_id: rp.redirect_uri, registration: rp.registration }, options), { response_type: (options.response_type === 'code' || options.response_type === 'id_token') ? options.response_type : 'id_token' });
                    jwtObject = {
                        header: jwtHeader,
                        payload: jwtPayload
                    };
