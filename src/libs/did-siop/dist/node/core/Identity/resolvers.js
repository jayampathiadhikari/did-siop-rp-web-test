...
exports.ethrDidResolver = exports.combinedDidResolver = void 0;
...
var EthrDidResolver = /** @class */ (function (_super) {
    ...
    EthrDidResolver.prototype.resolveDidDocumet = function (did) {
        return __awaiter(this, void 0, void 0, function () {
            var providerConfig, ethrDidResolver, didResolver, doc, didDoc;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        providerConfig = { rpcUrl: 'https://rinkeby.infura.io/ethr-did' };
                    ...
                    case 1:
                        doc = _a.sent();
                        didDoc = __assign(__assign({}, doc), { "@context": doc["@context"], authentication: doc.authentication || [], id: doc.id });
...
exports.ethrDidResolver = new EthrDidResolver('ethr');
